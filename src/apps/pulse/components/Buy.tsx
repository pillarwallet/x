      ...
      const intent: UserIntent = {
        constraints: {
          ...
          desiredAssets: [{
            ...
            value: getDesiredAssetValue(input, props.token.decimals, props.token.usdValue)
          }],
          dispensableAssets,
    ...
    <>
        ...
        <div className="flex justify-between" style={{margin: 10}}>
          <div className="flex">
            {
              ...
              <>
                ...
                <div style={{textDecoration: "underline", color: "#FF366C", fontSize: 12, marginLeft: 5}}>
          ...
          <div className="flex" style={{float: "right"}}>
            <svg width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1 3.5C1 2.39543 1.89543 1.5 3 1.5H15C16.1046 1.5 17 2.39543 17 3.5V9.5C17 10.6046 16.1046 11.5 15 11.5H3C1.89543 11.5 1 10.6046 1 9.5V3.5Z" fill="#8A77FF"/>
              <path d="M5 0.25C6.79493 0.25 8.25 1.70507 8.25 3.5C8.25 5.29493 6.79493 6.75 5 6.75C3.20507 6.75 1.75 5.29493 1.75 3.5C1.75 1.70507 3.20507 0.25 5 0.25Z" fill="#0052FF" stroke="#121116" stroke-width="0.5"/>
              <path d="M4.99635 5.49985C6.10285 5.49985 6.99985 4.6044 6.99985 3.49985C6.99985 2.39528 6.10285 1.49985 4.99635 1.49985C3.94658 1.49985 3.08538 2.30583 2.99985 3.33172H5.64799V3.66795H2.99985C3.08538 4.69386 3.94658 5.49985 4.99635 5.49985Z" fill="#E3E7E9"/>
              <path d="M13 0.25C14.7949 0.25 16.25 1.70507 16.25 3.5C16.25 5.29491 14.7949 6.75 13 6.75C11.2051 6.75 9.75 5.29491 9.75 3.5C9.75 1.70507 11.2051 0.25 13 0.25Z" fill="white" stroke="#121116" stroke-width="0.5"/>
              <path d="M13 0.5C11.3431 0.5 10 1.84315 10 3.5C10 5.15684 11.3431 6.5 13 6.5C14.6568 6.5 16 5.15684 16 3.5C16 1.84315 14.6568 0.5 13 0.5ZM13 5.02748V6.28022C11.8105 6.28022 10.8462 5.3159 10.8462 4.12637C10.8462 2.93684 11.8105 1.97253 13 1.97253V0.71978C14.1895 0.71978 15.1538 1.68409 15.1538 2.87363C15.1538 4.06316 14.1895 5.02748 13 5.02748ZM14.033 3.49039V3.5096C13.5777 3.73652 13.2365 4.07765 13.0096 4.53296H12.9904C12.7635 4.07765 12.4223 3.73652 11.967 3.5096V3.49039C12.4223 3.26347 12.7635 2.92234 12.9904 2.46703H13.0096C13.2365 2.92234 13.5777 3.26347 14.033 3.49039Z" fill="#FF0420"/>
              <path d="M9 0.25C10.7949 0.25 12.25 1.70507 12.25 3.5C12.25 5.29493 10.7949 6.75 9 6.75C7.20507 6.75 5.75 5.29493 5.75 3.5C5.75 1.70507 7.20507 0.25 9 0.25Z" fill="#627EEA" stroke="#121116" stroke-width="0.5"/>
              <path d="M9.09293 1.25V2.91312L10.4986 3.54125L9.09293 1.25Z" fill="white" fill-opacity="0.602"/>
              <path d="M9.09337 1.25L7.6875 3.54125L9.09337 2.91312V1.25Z" fill="white"/>
              <path d="M9.09293 4.61986V5.74993L10.4996 3.80386L9.09293 4.61986Z" fill="white" fill-opacity="0.602"/>
              <path d="M9.09337 5.74993V4.61968L7.6875 3.80386L9.09337 5.74993Z" fill="white"/>
              <path d="M9.09293 4.35718L10.4986 3.54099L9.09293 2.91324V4.35718Z" fill="white" fill-opacity="0.2"/>
              <path d="M7.6875 3.54099L9.09337 4.35718V2.91324L7.6875 3.54099Z" fill="white" fill-opacity="0.602"/>
              <path d="M4.5 4.25C5.2082 4.25 5.87488 4.58383 6.2998 5.15039L6.90039 5.9502L6.95703 6.01758C7.09767 6.16514 7.29362 6.25 7.5 6.25H10.5C10.7359 6.25 10.958 6.13886 11.0996 5.9502L11.7002 5.15039L11.7822 5.04688C12.2082 4.54321 12.8359 4.25 13.5 4.25H16C16.6904 4.25 17.25 4.80964 17.25 5.5V9.5C17.25 10.7426 16.2426 11.75 15 11.75H3C1.75736 11.75 0.75 10.7426 0.75 9.5V5.5C0.75 4.80964 1.30964 4.25 2 4.25H4.5Z" stroke="#121116" stroke-width="0.5"/>
              <path d="M1 5.5C1 4.94772 1.44772 4.5 2 4.5H4.5C5.12951 4.5 5.72229 4.79639 6.1 5.3L6.7 6.1C6.88885 6.35181 7.18524 6.5 7.5 6.5H10.5C10.8148 6.5 11.1111 6.35181 11.3 6.1L11.9 5.3C12.2777 4.79639 12.8705 4.5 13.5 4.5H16C16.5523 4.5 17 4.94772 17 5.5V9.5C17 10.6046 16.1046 11.5 15 11.5H3C1.89543 11.5 1 10.6046 1 9.5V5.5Z" fill="#4E448A"/>
            </svg>
            <div style={{color: "#8A77FF", marginLeft: 5, fontSize: 12, lineHeight: 0.9}}>
              ${props.walletPortfolioData?.result.data.total_wallet_balance.toFixed(2) || 0.00}
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <button
          ...
          disabled={isDisabled()}
          style={{margin: 2, backgroundColor: isDisabled() ? "#121116" : "#8A77FF", borderRadius: 10}}
        >
          {
            isLoading ?
            <>
