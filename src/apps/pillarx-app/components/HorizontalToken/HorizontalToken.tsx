...
const HorizontalToken = ({ tokenIndex, tokenLogo, tokenSymbol, tokenName, tokenValue, percentage, isLast, onClick }: HorizontalTokenProps) => {
    return (
        <div className={`flex w-full justify-between py-5 cursor-pointer ${!isLast && 'border-b border-[#1F1D23] mobile:border-[#27262F]'} ${isLast && tokenIndex === 3 && 'mobile:border-b mobile:border-[#27262F]'}`} onClick={onClick}>
