...
// types
import { ApiLayout, EditorialDisplay, Projection } from '../../../../../types/api';
...
describe('<EditorialTile />', () => {
    ...
    const mockEditorialDisplay = mockDataEditorial.meta.display as EditorialDisplay;
    ...
    it('renders skeleton loader when data is loading', () => {
        render(<EditorialTile data={undefined} isDataLoading={true} />);
    ...
    it('renders correctly with all the given data', () => {
        ...
        expect(screen.getByText(moment(new Date(mockEditorialDisplay.timestamp as number * 1000)).format('D MMMM YYYY'))).toBeInTheDocument();
    });
    ...
    it('does not render the attribution if not provided', () => {
        ...
        render(<EditorialTile data={mockDataWithoutAttribution} isDataLoading={false} />);
