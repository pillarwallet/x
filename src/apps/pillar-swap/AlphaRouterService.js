...
const RPC =
  'https://eth-sepolia.g.alchemy.com/v2/QdA15emJqv1MJIKgWbAni6N7hIIam8ze';
...
export const getPillarXContract = () =>
  new ethers.Contract(address0, PillarXABI, web3Provider);
export const getPillarYContract = () =>
  new ethers.Contract(address1, PillarYABI, web3Provider);
