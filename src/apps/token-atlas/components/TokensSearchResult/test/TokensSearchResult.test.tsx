...
const mockTokens: Token[] = [
    { name: 'Token1', symbol: 'TK1', chainId: 1, icon: 'logo1.png', decimals: 18, address: '0x01' },
    { name: 'Token2', symbol: 'TK2', chainId: 2, icon: 'logo2.png', decimals: 18, address: '0x02' }
];

const mockTokenListData: Token[] = [
    { name: 'TokenList1', symbol: 'TL1', chainId: 1, icon: 'listLogo1.png', decimals: 18, address: '0x01' },
    { name: 'TokenList2', symbol: 'TL2', chainId: 2, icon: 'listLogo2.png', decimals: 18, address: '0x02' }
];
...
describe('<TokensSearchResult />', () => {
    ...
    it('handles token selection', () => {
        const mockToken: Token = { name: 'TestToken', symbol: 'TTK', chainId: 1, icon: 'testLogo.png', decimals: 6, address: '0x06' };
