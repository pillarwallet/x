...
// reducer
import { setIsGraphLoading, setSelectedToken, setTokenDataGraph, setTokenDataInfo } from './reducer/tokenAtlasSlice';
  ...
  return (
    <Wrapper>
      ...
      <div className="flex w-full mobile:flex-col">
        <TokenGraphColumn className='basis-3/5' isLoadingTokenDataInfo={isLoadingTokenDataInfo || isFetchingTokenDataInfo} isLoadingTokenDataGraph={isLoadingTokenDataGraph || isFetchingTokenDataGraph} />
        <TokenInfoColumn className='basis-2/5' isLoadingTokenDataInfo={isLoadingTokenDataInfo || isFetchingTokenDataInfo} />
      </div>
    </Wrapper>
  );
};
