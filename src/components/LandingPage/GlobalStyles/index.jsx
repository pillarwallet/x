  ...
  * {
  ...
  @media only screen and (max-width: 1024px) {
    .header__menu {
      ...
      background: linear-gradient(180deg, rgba(0,0,0,1) 0%, rgba(16,16,16,1) 50%, rgba(138,119,255,1) 100%);
  ...
  #menu>li>ul {
    ...
    top: -1.2rem;
    left: 50%;
    padding: calc(var(--padding) * 4) calc(var(--padding) * 0.5) calc(var(--padding) * 0.5) calc(var(--padding) * 0.5);
    margin: 0;
...
#menu li ul li a:hover{
  background: linear-gradient(93.73deg, rgba(255, 255, 255, 0.05) 0%, rgba(255, 255, 255, 0.03) 22.6%, rgba(255, 255, 255, 0.01) 77.88%, rgba(255, 255, 255, 0.05) 100%);
  box-shadow: 0px 4px 20px rgba(0, 0, 0, 0.2); 
  backdrop-filter: blur(5px);
...
#menu li ul li a.active::after {
  ...
  .home_app__subscribe {
    ...
    background: linear-gradient(0deg, rgba(138, 119, 255, 0.3) -0.1%, #8A77FF 100%); mix-blend-mode: plus-lighter; 
    border-radius: 2.4rem;
    width: 100%;
    max-width: 91.5rem;
    display: flex;
